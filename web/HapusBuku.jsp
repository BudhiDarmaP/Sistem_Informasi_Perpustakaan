                    ...
                    <article>
                        <div class="features">
                            ...
                            <form method="post" action="ControlHapusBuku">
                                <!-- Break -->
                                <table>
                                    <tr><input type="text" id="demo-copy" name="demo-isbn" placeholder="ISBN" value="<%=b.getISBN()%>"/>
                                    <tr><input type="text" id="demo-copy" name="demo-judul" placeholder="Judul" value="<%=b.getJudul()%>" disabled/>
                                    <tr> <input type="text" id="demo-copy" name="demo-author" placeholder="Author" value="<%=b.getPenulis()%>" disabled/>
                                    <tr><input type="text" id="demo-copy" name="demo-penerbit" placeholder="Penerbit" value="<%=b.getPenerbit()%>" disabled/>
                                    <tr><ul class="actions">
                                        <li><input type="text" id="demo-copy" name="demo-tahun" placeholder="Tahun" value="<%=b.getTahun_Terbit()%>" disabled/></li>
                                        <li><input type="number" id="demo-copy" name="demo-copy" placeholder="Copy" value="<%=b.getKetersediaan()%>" disabled/></li>
                                    </ul>
                                    <tr><ul class="actions">

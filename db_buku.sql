...
SET DEFINE OFF;
Insert into SIA.PTI_BUKU (ISBN,JUDUL,PENULIS,TAHUN_TERBIT,PENERBIT,KETERSEDIAAN) values ('9780596000950','Programming Web Services with SOAP','James Snell, Doug Tidwell, Pavel Kulchenko','2001','O''Reilly Media',3);
...
Insert into SIA.PTI_BUKU (ISBN,JUDUL,PENULIS,TAHUN_TERBIT,PENERBIT,KETERSEDIAAN) values ('9781455539741','Hamilton: The Revolution','Lin-Manuel Miranda','2016','Grand Central Publishing',1);
